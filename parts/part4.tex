...
大连理工大学提出的DUT-LFSD\upcite{zhang2019memory}和
DUTLF-V2\upcite{piao2020dut}，
...
同时按照近期的方法\upcite{wang2022lfbcnet,jing2021occlusion}
...
\begin{table}[t]
	...
	\centering
	\label{chpt4:table:comp_multi_view}
	\resizebox{0.68\linewidth}{!}{
		\begin{tabular}{crcccc}
			...
			\textbf{ 0.959 } & \textbf{ 0.921 }  & \textbf{ 0.908 }  & \textbf{ 0.026 }  \\ 
...
%			\cmidrule(r){2-5} \cmidrule(r){6-9} 
			...
			二元交叉熵损失 & 0.968 & 0.933 & 0.944 & 0.027 & 0.873 & 0.828 & 0.788 & 0.061   \\
				
%			二元交叉熵损失   & 0.965 & 0.931 & 0.943 & 0.027 & 0.885 & 0.840 & 0.810 & 0.056  \\

			+前景像素对比学习损失 
			& 0.967	& 0.936	& 0.946	& 0.025	
			& 0.885	& 0.840 & 0.805	& 0.055 \\
