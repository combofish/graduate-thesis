...
%	\resizebox{0.98\linewidth}{!}{
	%		\begin{tabular}{ccccc}
		%				\toprule
		%				
		%				        Model & input size & FPS & Complexity(GMac) & Parameters(M) \\ 
		%				       
		%				        \midrule
		%				        
		%						Ours & 256x256 & 9 & 62.44 & 94.93 \\ 
		%						DLGLRG[] & 256x256 & 8 & 354.21 & 41.93 \\ 
		%						SANet[] & 352x352 & 11 & 126.91 & 66.91 \\ 
		%						ERNet-T[] & 256x256 & 14 & 351.34 & 23.11 \\ 
		%				
		%					\bottomrule
		%			\end{tabular}
	%	}
